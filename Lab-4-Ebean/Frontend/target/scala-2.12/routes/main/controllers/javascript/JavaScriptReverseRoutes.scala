...
package controllers.javascript {
  ...
  class ReverseHomeController(_prefix: => String) {
    ...
    def findCategoryArticles: JavaScriptReverseRoute = JavaScriptReverseRoute(
      "controllers.HomeController.findCategoryArticles",
      """
        function() {
          return _wA({method:"GET", url:"""" + _prefix + { _defaultPrefix } + """" + "find-category-articles"})
        }
      """
    )
    ...
    // @LINE:49
    def AllWFController: JavaScriptReverseRoute = JavaScriptReverseRoute(
      "controllers.HomeController.AllWFController",
      """
        function() {
          return _wA({method:"GET", url:"""" + _prefix + { _defaultPrefix } + """" + "find-all-workflow"})
        }
      """
    )
    ...
    // @LINE:47
    def WFController: JavaScriptReverseRoute = JavaScriptReverseRoute(
      "controllers.HomeController.WFController",
      """
        function() {
          return _wA({method:"GET", url:"""" + _prefix + { _defaultPrefix } + """" + "find-best-workflow"})
        }
      """
    )
