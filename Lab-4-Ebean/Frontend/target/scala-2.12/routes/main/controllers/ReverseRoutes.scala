...
package controllers {
  ...
  class ReverseHomeController(_prefix: => String) {
    ...
    // @LINE:45
    def findCategoryArticles(): Call = {
      
      Call("GET", _prefix + { _defaultPrefix } + "find-category-articles")
    }
    ...
    // @LINE:49
    def AllWFController(): Call = {
      
      Call("GET", _prefix + { _defaultPrefix } + "find-all-workflow")
    }
    ...
    // @LINE:47
    def WFController(): Call = {
      
      Call("GET", _prefix + { _defaultPrefix } + "find-best-workflow")
    }
