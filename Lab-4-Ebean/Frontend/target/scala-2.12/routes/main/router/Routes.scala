...
class Routes(
  ...
  def documentation = List(
    ...
    ("""GET""", this.prefix + (if(this.prefix.endsWith("/")) "" else "/") + """find-category-articles""", """controllers.HomeController.findCategoryArticles()"""),
    ("""GET""", this.prefix + (if(this.prefix.endsWith("/")) "" else "/") + """find-best-workflow""", """controllers.HomeController.WFController()"""),
    ("""GET""", this.prefix + (if(this.prefix.endsWith("/")) "" else "/") + """find-all-workflow""", """controllers.HomeController.AllWFController()"""),
    Nil
  ...
  // @LINE:45
  private[this] lazy val controllers_HomeController_findCategoryArticles19_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("find-category-articles")))
  )
  private[this] lazy val controllers_HomeController_findCategoryArticles19_invoker = createInvoker(
    HomeController_1.findCategoryArticles(),
    play.api.routing.HandlerDef(this.getClass.getClassLoader,
      "router",
      "controllers.HomeController",
  ...
  // @LINE:47
  private[this] lazy val controllers_HomeController_WFController20_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("find-best-workflow")))
  )
  private[this] lazy val controllers_HomeController_WFController20_invoker = createInvoker(
    HomeController_1.WFController(),
    play.api.routing.HandlerDef(this.getClass.getClassLoader,
      "router",
      "controllers.HomeController",
      "WFController",
  ...
  // @LINE:49
  private[this] lazy val controllers_HomeController_AllWFController21_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("find-all-workflow")))
  )
  private[this] lazy val controllers_HomeController_AllWFController21_invoker = createInvoker(
    HomeController_1.AllWFController(),
    play.api.routing.HandlerDef(this.getClass.getClassLoader,
      "router",
      "controllers.HomeController",
      "AllWFController",
  ...
  def routes: PartialFunction[RequestHeader, Handler] = {
    ...
    // @LINE:45
    case controllers_HomeController_findCategoryArticles19_route(params@_) =>
      call { 
        controllers_HomeController_findCategoryArticles19_invoker.call(HomeController_1.findCategoryArticles())
      }
  
    // @LINE:47
    case controllers_HomeController_WFController20_route(params@_) =>
      call { 
        controllers_HomeController_WFController20_invoker.call(HomeController_1.WFController())
      }
  
    // @LINE:49
    case controllers_HomeController_AllWFController21_route(params@_) =>
      call { 
        controllers_HomeController_AllWFController21_invoker.call(HomeController_1.AllWFController())
      }
  }
}
