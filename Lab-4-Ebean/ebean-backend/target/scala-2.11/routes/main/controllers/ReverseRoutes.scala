...
package controllers {
  ...
  class ReverseworkflowController(_prefix: => String) {
    ...
    def findBestWF(): Call = {
      import ReverseRouteContext.empty
      Call("POST", _prefix + { _defaultPrefix } + "find-best-workflow")
    }
  ...
  class ReverseCategoryArticlesController(_prefix: => String) {
    ...
    def findCategoryArticles(): Call = {
      import ReverseRouteContext.empty
      Call("POST", _prefix + { _defaultPrefix } + "find-category-articles")
    }
  ...
  class ReverseallWorkflowController(_prefix: => String) {
    ...
    def findAllWF(): Call = {
      import ReverseRouteContext.empty
      Call("POST", _prefix + { _defaultPrefix } + "find-all-workflow")
    }
