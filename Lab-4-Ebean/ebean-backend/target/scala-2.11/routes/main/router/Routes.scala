...
class Routes(
  ...
  // @LINE:21
  Controller22_9: controllers.Controller22,
  // @LINE:24
  ...
  // @LINE:37
  workflowController_8: controllers.workflowController,
  // @LINE:39
  allWorkflowController_10: controllers.allWorkflowController,
  val prefix: String
   ...
   def this(errorHandler: play.api.http.HttpErrorHandler,
    ...
    // @LINE:39
    allWorkflowController_10: controllers.allWorkflowController
  ) = this(errorHandler, HomeController_0, Controller11_4, Controller12_6, Controller1321_3, Controller14_1, Controller22_9, ConferenceController_7, UserController_5, CategoryArticlesController_2, workflowController_8, allWorkflowController_10, "/")

  import ReverseRouteContext.empty

  def withPrefix(prefix: String): Routes = {
    router.RoutesPrefix.setPrefix(prefix)
    new Routes(errorHandler, HomeController_0, Controller11_4, Controller12_6, Controller1321_3, Controller14_1, Controller22_9, ConferenceController_7, UserController_5, CategoryArticlesController_2, workflowController_8, allWorkflowController_10, prefix)
  }
  ...
  def documentation = List(
    ...
    ("""POST""", this.prefix + (if(this.prefix.endsWith("/")) "" else "/") + """find-best-workflow""", """controllers.workflowController.findBestWF()"""),
    ("""POST""", this.prefix + (if(this.prefix.endsWith("/")) "" else "/") + """find-all-workflow""", """controllers.allWorkflowController.findAllWF()"""),
    Nil
  ...
  // @LINE:37
  private[this] lazy val controllers_workflowController_findBestWF10_route = Route("POST",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("find-best-workflow")))
  )
  private[this] lazy val controllers_workflowController_findBestWF10_invoker = createInvoker(
    workflowController_8.findBestWF(),
    HandlerDef(this.getClass.getClassLoader,
      "router",
      ...
      "POST",
      """""",
      this.prefix + """find-best-workflow"""
    )
  )

  // @LINE:39
  private[this] lazy val controllers_allWorkflowController_findAllWF11_route = Route("POST",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("find-all-workflow")))
  )
  private[this] lazy val controllers_allWorkflowController_findAllWF11_invoker = createInvoker(
    allWorkflowController_10.findAllWF(),
    HandlerDef(this.getClass.getClassLoader,
      "router",
      "controllers.allWorkflowController",
      "findAllWF",
      Nil,
      "POST",
      """""",
      this.prefix + """find-all-workflow"""
    )
  )
  ...
  def routes: PartialFunction[RequestHeader, Handler] = {
    ...
    case controllers_Controller22_output225_route(params) =>
      call { 
        controllers_Controller22_output225_invoker.call(Controller22_9.output22())
      }
    ...
    // @LINE:37
    case controllers_workflowController_findBestWF10_route(params) =>
      call { 
        controllers_workflowController_findBestWF10_invoker.call(workflowController_8.findBestWF())
      }
  
    // @LINE:39
    case controllers_allWorkflowController_findAllWF11_route(params) =>
      call { 
        controllers_allWorkflowController_findAllWF11_invoker.call(allWorkflowController_10.findAllWF())
      }
  }
}
